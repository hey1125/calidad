    ...
    this.InitView = function () {
        ...
        $("#btnSiguiente").on("click", function () {
            ...
            if (!/^\d{8}$/.test($("#Telefono").val())) {
                Swal.fire("Error", "El teléfono debe tener 8 dígitos numéricos", "error");
                isValid = false
                return;
            }
            ...
            if (isNaN($("#txtLatitude").val()) || isNaN($("#txtLongitude").val())) {
                Swal.fire("Ubicación requerida", "Seleccione la ubicación en el mapa.", "warning");
                isValid = false;
                return;
            }
